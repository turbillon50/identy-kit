...
export async function POST(req: NextRequest) {
  ...
  const fields = ["curp","nombre","apellidos","fecha_nacimiento","tipo_sangre","alergias","padecimientos","contacto_emergencia_nombre","contacto_emergencia_tel","escuela","grado"];
